        ...
        <div className="min-h-screen bg-white flex flex-col">
            <main className="flex-1 flex flex-col items-center p-3">
                ...
                <h2 className="text-2xl font-bold text-gray-800 mb-10 ">
                    {toggleActive === 'login' ? 'Welcome Back ' : 'Sign up for '}
                    <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-500 to-purple-600 ">CodePi</span>
                </h2>

                <div className="w-[500px] flex flex-col shadow-lg rounded-lg overflow-hidden">
            

                    <div className=" p-6  justify-center  border-l border-gray-100">

                        <div className="py-2 px-7 mb-6 mt-2">
                            <button className="w-full bg-white cursor-pointer border border-gray-300 rounded-lg p-2 flex items-center justify-center hover:bg-gray-50 h-9 transition shadow-sm" onClick={handleContinueWithGoogle}>
                            ...
                            {/* <button className="w-full bg-white cursor-pointer border border-gray-300 rounded-lg h-9 p-2 flex items-center justify-center hover:bg-gray-50 transition shadow-sm">
                                ...
                                <div className=" flex relative items-center w-full">
                                    <div className='border flex-grow border-gray-200'></div>
                                    <span className="text-gray-500 text-sm pb-0.5 mx-2 font-medium">or</span>
                                    <div className='border flex-grow border-gray-200'></div>
                                </div>
